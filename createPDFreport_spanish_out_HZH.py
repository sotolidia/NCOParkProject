...
def createPDFreport_spanish_out_HZH(patient_age, region, subjectANDoutput_dir, metric='vol', prediction_intervals_dir = '/home/neurocogn/N1.0Dir/NezihNiegu/neuroimaging_processor/Volumetry/batches/prediction_intervals/'):
	...
	if low_reference[k] < 0.00:
        	low_reference[k]=0.00
